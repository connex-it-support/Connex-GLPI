   ...
   //                       $tt->getMandatoryMark('itilcategories_id'))."</td>";
    //  echo "<td>";
      ...
      if (!$tt->isHiddenField('content')
         ...
         echo "<tr class='tab_bg_1'>";
         echo "<td>".sprintf(__('%1$s%2$s'), __(''), $tt->getMandatoryMark('content'));
   ...
   //   }
    ...
    //  echo "</td>";
     // echo "</tr>";
      ...
      //echo "<tr class='tab_bg_1'>";
     //echo "<th width='$colsize1%'>".sprintf(__('%1$s%2$s'), __(''),
...
/// end 
      ...
      printf(__('%1$s%2$s'), __(''), $tt->getMandatoryMark('content'));
      if ($canupdate) {
