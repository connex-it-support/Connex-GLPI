...
class PluginFieldsTicketteamviewerInjection extends PluginFieldsTicketteamviewer implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Ticket::getTypeName() . " - TeamViewer";
   }
