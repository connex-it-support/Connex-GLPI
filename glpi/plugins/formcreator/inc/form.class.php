...
class PluginFormcreatorForm extends CommonDBTM
{
   ...
   public static function getTypeName($nb = 0) {
      return _n('Form', 'Create Ticket', $nb, 'formcreator');
   }
   ...
   public function getTabNameForItem(CommonGLPI $item, $withtemplate=0) {
      switch ($item->getType()) {
         ...
         case "PluginFormcreatorForm":
            ...
            break;
         case 'Central':
            return _n('Form', 'T', 2, 'formcreator');
            break;
      }
      return '';
   }
   ...
   **/
   ...
   public function showForCentral() {
      ...
      if ($DB->numrows($result) > 0 || $DB->numrows($result_forms) > 0) {
        ...
        echo '<th><a href="../plugins/formcreator/front/formlist.php">' . _n('', '', 2, 'formcreator') . '</a></th>';
        echo '</tr>';
   ...
   static function header() {
      switch (self::getInterface()) {
         ...
         case "self-service";
            return Html::helpHeader(__('Ticket', 'formcreator'), $_SERVER['PHP_SELF']);
         case "central";
            return Html::header(
