...
class PluginFormcreatorForm_Answer extends CommonDBChild
{
   ...
   **/
   ...
   public function saveAnswers($data) {
      ...
      Session::addMessageAfterRedirect(__('Thank you for using the Connex Help Desk!', 'formcreator'), true, INFO);
   }
   ...
   public function generateTarget() {
      ...
      Session::addMessageAfterRedirect(__('', 'formcreator'), true, INFO);
