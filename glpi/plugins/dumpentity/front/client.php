<?php
/*
 * @version $Id: client.php 144 2015-09-06 18:05:31Z yllen $
 -------------------------------------------------------------------------
  LICENSE
...
Html::header(PluginDumpentityClient::getTypeName(2), $_SERVER["PHP_SELF"],
             'plugins', 'dumpentity', 'client');

Search::show('PluginDumpentityClient');
