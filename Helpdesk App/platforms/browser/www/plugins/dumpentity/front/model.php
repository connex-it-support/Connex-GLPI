<?php
/*
 * @version $Id: model.php 144 2015-09-06 18:05:31Z yllen $
 -------------------------------------------------------------------------
  LICENSE
...
Html::header(PluginDumpentityModel::getTypeName(2), $_SERVER["PHP_SELF"],
             'plugins', 'dumpentity', 'model');

Search::show('PluginDumpentityModel');
